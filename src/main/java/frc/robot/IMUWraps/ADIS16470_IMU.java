...
public class ADIS16470_IMU implements AutoCloseable, NTSendable {
  ...
  // Instant raw outputs
  protected double m_gyro_rate_x = 0.0;
  protected double m_gyro_rate_y = 0.0;
  protected double m_gyro_rate_z = 0.0;
  protected double m_accel_x = 0.0;
  protected double m_accel_y = 0.0;
  protected double m_accel_z = 0.0;

  // Integrated gyro angle
  protected double m_integ_angle = 0.0;
